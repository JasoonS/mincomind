...
function useWalletClient() {
  ...
  var connector = Core__Option.flatMap(Caml_option.nullable_to_opt(dynamicContext.primaryWallet), (function (pw) {
          return Caml_option.nullable_to_opt(pw.connector);
        }));
  React.useEffect((function () {
          if (connector !== undefined) {
            if (typeof state !== "object") {
              Core__Promise.$$catch(connector.getPublicClient().then(function (publicClient) {
                        var walletClient;
                        try {
        ...
        }), [Core__Option.map(connector, (function (c) {
